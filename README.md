...
# 📖 Microverse Portfolio Code review <a name="about-project"></a>

- An exercise by Microverse that prepares students for giving and receiving code reviews.
...
- Open the "index.html" file using your favourite browser.
